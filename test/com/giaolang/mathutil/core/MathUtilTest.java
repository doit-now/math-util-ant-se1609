...
public class MathUtilTest {
    ...
    //ngoại lệ thuộc nhóm/class IllegalArgumentException xh hay ko
...
//VIẾT CODE ĐỂ TEST CODE CHÍNH, THÌ CÁI ĐOẠN CODE TEST NÀY ĐC GỌI
//TÊN LÀ TEST SCRIPT
...
//@Test @ đc gọi ANNOTATION, kí hiệu, flag để đánh dấu đoạn code
//mang 1 ý nghĩa nào đó. Và khi biên dịch/compile code thì 
//thư viện đi kèm nó sẽ tự động generate thêm code cho mình tuỳ theo\
//@
//ví dụ @Test thì thư viên JUnit nãy import nó sẽ ngầm ngầm tự generate
...
//Thư viên - library, những file .jar .dll chứa 1 đống class bên trong
...
//code gọn hơn, đẹp hơn, dễ bảo trì hơn, kiểm soát đc đủ thiếu các case
//kĩ thuật tách code test ra khỏi data của nó, lát hồi fill lại sau
//đc GỌI LÀ KĨ THUẬT VIẾT TEST CASE THEO KIỂU THAM SỐ HOÁ
//                                            PARAMETERIZED
